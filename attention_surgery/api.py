...
# Mount static assets (JS, CSS, images) if the directory exists
if FRONTEND_DIST.exists():
    app.mount("/assets", StaticFiles(directory=str(FRONTEND_DIST / "assets")), name="assets")

    # Serve index.html for root path and all other routes (SPA routing)
    @app.get("/")
    ...
    async def serve_spa(full_path: str):
        ...
        # If it's an API route, skip this handler (FastAPI will handle it)
    ...
    print("Frontend will not be served. API endpoints are still available.")
